...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.aosap.update.version";
    public static final String PROP_DEVICE = "ro.aosap.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.aosap.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "lineage.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "aosap.updater.uri";
